      ...
      >
        ...
        >
          ...
          <h1 class="text-center text-info">
            <strong>Carta de Aceptación Laboral</strong>
          </h1>
          <hr class="invoice-spacing mb-5">

          <!-- Contenido central: Carta de aceptación -->
          <b-card-body
            v-if="employeeData"
          ...
          >
            ...
            >
              ...
              <p class="mb-2">
                Por medio de la presente, <span class="font-weight-bold">DISTRIBUIDORA E INVERSIONES LACTEOS MV 2016, C.A.</span> tiene el agrado de informar que el(la) ciudadano(a) <span class="font-weight-bold">{{ employeeData.name }} {{ employeeData.last_name }}</span>, titular de la cédula de identidad N° <span class="font-weight-bold">{{ employeeData.dni }}</span>, ha sido aceptado(a) para desempeñar el cargo de <span class="font-weight-bold">{{ employeeData.position }}</span> en el departamento de <span class="font-weight-bold">{{ employeeData.department }}</span> de nuestra empresa.
              </p>
              <p class="mb-1">
                La fecha de inicio de labores será el día <span class="font-weight-bold">{{ new Date(employeeData.hire_date).toLocaleDateString('es-ES', { day: 'numeric', month: 'long', year: 'numeric' }) }}</span>.
              </p>
              <p class="mb-1">
              ...
              <p class="mb-5">
                Esta carta se expide en Sabaneta de Barinas, a los {{ new Date().getDate() }} días del mes de {{ new Date().toLocaleDateString('es-ES', { month: 'long', year: 'numeric' }) }}, como constancia de aceptación y para los fines que el interesado estime convenientes.
              </p>
